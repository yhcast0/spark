...
import org.apache.spark.sql.catalyst.planning.ExtractSingleColumnNullAwareAntiJoin.{canBroadcastBySize, hintToBroadcastLeft, hintToBroadcastRight}
 ...
 */
object DynamicFilterPruning extends Rule[LogicalPlan] with PredicateHelper {
  ...
  private def partitionPruningHasBenefit(
    ...
    filterRatio * partPlan.stats.sizeInBytes.toFloat > overhead
  }
